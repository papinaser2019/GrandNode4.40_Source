...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
                ...
                if (registrationResult.Success)
                {
                    ...
                    if (_customerSettings.DateOfBirthEnabled)
                    {
                        ...
                        try
                        {
                            ...
                            _genericAttributeService.SaveAttribute(customer, NopCustomerDefaults.DateOfBirthAttribute, dt);
                        }
                        catch { }
        ...
        public virtual IActionResult Info()
        {
            ...
            //persian Date
            var dt = model.ParseDateOfBirth();
            var pc = new PersianCalendar();
            if (dt.HasValue)
            {
                model.DateOfBirthYear = pc.GetYear(dt.Value);
                model.DateOfBirthMonth = pc.GetMonth(dt.Value);
                model.DateOfBirthDay = pc.GetDayOfMonth(dt.Value);
            }
